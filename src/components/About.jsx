    ...
    return (
        <div id='about' className='min-h-[100vh] pt-16'>
            ...
            <div className='flex flex-col md:flex-row justify-between gap-10 mt-12'>
                <div className='bg-myColor rounded-xl w-1/2 lg:w-full mx-auto'>
                    <img className='rounded-xl h-full transform rotate-12 hover:rotate-0 duration-75' src={person} alt="person" />
                </div>
